...
p.add("Return girl home","Girl appeared in Monster Inc.",
        ...
        System.out.println(" | "+E2.elements.get(0).getLore_id()+" | " + E2.elements.get(0).getCname()+" | "
                + E2.elements.get(0).getAname()+" | " + E2.elements.get(0).getLocation()+" | ");
        System.out.println(" | "+E2.elements.get(1).getLore_id()+" | " + E2.elements.get(1).getCname()+" | "
                + E2.elements.get(1).getAname()+" | "+ E2.elements.get(1).getLocation()+" | ");
        System.out.println(" | "+E2.elements.get(2).getLore_id()+" | " + E2.elements.get(2).getCname()+" | "
...
E2.Red(E2.elements.get(0).getLore_id(),"Alladin","Jafar","Agraba");
        System.out.println(" | "+E2.elements.get(0).getLore_id()+" | " + E2.elements.get(0).getCname()+" | "
                + E2.elements.get(0).getAname()+" | " + E2.elements.get(0).getLocation()+" | ");


        p.Red(p.plot.get(0).getPlot_id(),"Make Jasmin fall in love, defeat Jafar",
        ...
        Ct.Del(Ct.Cartoons.get(0).getCart_id(),"Alladin","5");

        for (int n=0;n<Cartoons.size();n++)
        {System.out.println(Ct.Cartoons.get(n).getName());}

        System.out.println(E1.elements.get(0).getName());

        E1.Del(E1.elements.get(0).getCompany_id() ,"Disney+","US");
        ...
        for (int n=0;n< elements.size();n++)
      {
        ...
        E2.Del("Alladin","Jafar","Agraba");

        System.out.println(E2.elements.get(0).getLocation());
